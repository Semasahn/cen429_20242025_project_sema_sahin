...
call reportgenerator "-title:travelexpensetracker Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:travelexpensetracker Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for travelexpensetracker
call OpenCppCoverage.exe --export_type=binary:travelexpensetracker_tests_unit_win.cov --sources src\travelexpensetracker\src --sources src\travelexpensetracker\header --sources src\tests\travelexpensetracker -- build_win\build\Debug\travelexpensetracker_tests.exe

echo Generate Test Coverage Data for travelexpensetracker App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=travelexpensetracker_tests_unit_win.cov --export_type=cobertura:travelexpensetrackerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\travelexpensetracker\src --sources src\travelexpensetracker\header --sources src\travelexpensetrackerapp\src --sources src\travelexpensetrackerapp\header --sources src\tests\utility --sources src\tests\travelexpensetracker -- build_win\build\Debug\travelexpensetrackerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:travelexpensetracker Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/travelexpensetrackerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/travelexpensetracker/src;src/travelexpensetracker/header;src/travelexpensetrackerapp/src;src/travelexpensetrackerapp/header;src/tests/utility;src/tests/travelexpensetracker" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/travelexpensetrackerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/travelexpensetracker/src;src/travelexpensetracker/header;src/travelexpensetrackerapp/src;src/travelexpensetrackerapp/header;src/tests/utility;src/tests/travelexpensetracker" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\travelexpensetracker\header "build_win\build\Release" /E
call robocopy src\travelexpensetrackerapp\header "build_win\build\Release" /E
...
call robocopy src\travelexpensetracker\header "build_win\build\Debug" /E
call robocopy src\travelexpensetrackerapp\header "build_win\build\Debug" /E

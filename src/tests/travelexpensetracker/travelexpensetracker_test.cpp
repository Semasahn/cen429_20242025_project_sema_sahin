//#define ENABLE_TRAVEL_EXPENSE_TRACKER_TEST  // Uncomment this line to enable the travelexpensetracker tests

#include "gtest/gtest.h"
#include "../../travelexpensetracker/header/travelexpensetracker.h"  // Adjust this include path based on your project structure
